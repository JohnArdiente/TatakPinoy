...
namespace TatakPinoy.Controllers
{
    ...
    public class StatusController : Controller
    {
        ...
        public StatusController(TatakPinoyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusId,StatusDesc")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,StatusDesc")] Status status)
        {
